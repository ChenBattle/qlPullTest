...
push_config = {
    ...
    'QYWX_AM': 'ww0495cdf667e9a949,Sal-BSoKLht9OTA7l6muQrTm6Bp_znpyhBXXplgzHTI,@all,1000002,2LmwOG-iAOV3IJ_NJcp01uBJqIbspVrXC4AHlNlGKXHUbkV8tZ_MP0D_Uuo8xy_EB',                      # 企业微信应用
...
def one() -> str:
    ...
    return "%s(来自：%s)" % (res["hitokoto"], res["from"])
